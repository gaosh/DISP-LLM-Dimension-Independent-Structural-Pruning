...
class Qwen3Attention(nn.Module):
    ...
    def __init__(self, config: Qwen3Config, layer_idx: int):
        ...
        ex_dict = {
            ...
            "qo_dim": self.num_attention_heads * self.head_dim,
...
class Qwen3DecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3Config, layer_idx: int):
        ...
        self.self_attn.virtual_attn_gate_1.layer_id = layer_idx
        self.self_attn.virtual_attn_gate_2.layer_id = layer_idx
        self.mlp.virtual_block_gate_1.layer_id = layer_idx
        self.mlp.virtual_block_gate_2.layer_id = layer_idx
        self.mlp.virtual_gate.layer_id = layer_idx
